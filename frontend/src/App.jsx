...
const PromptBar = ({ onGenerate, disabled, loading }) => {
  ...
  const examples = [
    ...
    "Year wise sales for store 20",
    "Department wise average score and grade distribution",
    "Top 10 stores by total sales with yearly comparison",
  ];
...
const DashboardGrid = ({ charts, onDownload }) => {
  ...
  const plotLayout = (chart) => ({
    ...
    yaxis:{...chart.figure_json.layout?.yaxis,gridcolor:"#f0f1f6",linecolor:"#e5e7eb",zeroline:false},
  });
  return (
    <>
